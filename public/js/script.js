...
$(document).ready(function () {
  ...
  $('.akcija').css("top", h);
  $('.akcija').css("z-index", -1); //prelazak misa preko proizvoda

  $('.product').hover(function () {
    $(this).find('.opis').css("visibility", "hidden"); // $(this).find('.akcija').css("visibility","visible");
    // $(this).find('.akcija').css("width","100%");

    $(this).find('.akcija').css("top", "0");
    $(this).find('.akcija').css("z-index", "5");
  }, function () {
    $(this).find('.opis').css("visibility", "visible"); //  $(this).find('.akcija').css("visibility","hidden");
  ...
  $('#btnclose, #cart_shop_button').on('click', function () {
    $('#shopping_cart').toggleClass('show');
  });
